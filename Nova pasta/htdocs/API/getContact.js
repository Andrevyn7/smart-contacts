async function puxar() {
    ...
    let resp = await fetch("http://smartcontacts.infinityfreeapp.com/BACK/contact.php"); //Aqui a função trará todos os dados que foram pegos no banco de dados no arquivo contact.php
